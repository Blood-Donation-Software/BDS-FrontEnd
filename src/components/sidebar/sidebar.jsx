                ...
                <div className="flex items-center space-x-3">
                    ...
                    <div className="group-data-[collapsible=icon]:hidden">
                        ...
                        <div className="text-sm text-red-600 font-medium">
                            {pathname.includes("staff") ? "Staff" : "Admin"} Portal
                        </div>
                    </div>
                </div>
            </SidebarHeader>
                        ...
                        {items.map((item) => {
                            ...
                            return (
                                <SidebarMenu key={item.title}>
                                    {pathname.includes('admin') ? <Link href={`${item.url}`} passHref>
                            ...
                            <DropdownMenuTrigger asChild>
                                <SidebarMenuButton className="w-full flex items-center space-x-3 px-3 py-3 rounded-lg hover:bg-gray-100 transition-colors group">
                                    ...
                                    <div className="flex flex-col group-data-[collapsible=icon]:hidden">
                                        <span className="font-semibold text-gray-900 text-xs">{profile.name}</span>
